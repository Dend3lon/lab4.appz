    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityBooking", x => new { x.ActivitiesId, x.BookingsId });
                    table.ForeignKey(
                        name: "FK_ActivityBooking_Activities_ActivitiesId",
                        column: x => x.ActivitiesId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityBooking_Bookings_BookingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityBooking_BookingsId",
